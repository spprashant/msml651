...
trips_df = data_df.sample(fraction=0.01, seed=42)
...
#, "is_peaktime", "is_nighttime", "is_pickup_near_airport", "is_dropoff_near_airport", "pickup_month","pickup_year","pickup_dow", "passenger_count","nyc_is_precip","nyc_is_ice", "nyc_is_snow", "lga_is_precip","lga_is_ice", "lga_is_snow"
